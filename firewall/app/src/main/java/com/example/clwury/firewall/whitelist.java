...
public class whitelist extends AppCompatActivity implements AdapterView.OnItemLongClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        whitelist=(ListView) findViewById(R.id.lv);
        ...
        whitelist.setOnItemLongClickListener(this);
    }
    //长按删除
    public boolean onItemLongClick(AdapterView<?> parent, View view, final int position, long id) {

        new AlertDialog.Builder(this).setTitle("确定删除该号码？")
                ...
                .setPositiveButton("确定", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialogInterface, int i) {
                        ...
                        db.execSQL("delete from whitelist where number=?",new Object[]{number});
                        db.close();
                        mData.remove(position);
                        mAdapter.notifyDataSetChanged();
                        Toast.makeText(getApplicationContext(),"已删除该号码",Toast.LENGTH_SHORT).show();
                    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        if(event.getAction() == MotionEvent.ACTION_UP) {
            ...
            if(y1 - y2 > 50) {
                ...
                intent.setClass(whitelist.this, Smsbox.class);
